...
public class Stepdefs {
    ...
    @When("user {string} and password {string} are entered")
    public void newUserIsRegistered(String username, String password) {
        inputLines.add(username);
        inputLines.add(password);
        io = new StubIO(inputLines); 
        app = new App(io, auth);
    ...
    @Then("system will give message {string}")
    public void systemWillGiveMessage(String message) {
